<template>
  <div class="playlistDetails">
    <div class="introduce">
      ...
      <div class="text">
        <div class="title">
          ...
          <span class="name">{{ playlistDetails.PlaylistName }}</span>
        </div>
        <div class="operate">
        ...
        <div class="count">
          <div class="songsCount">歌曲：{{ playlistDetails.SongCount }}首</div>
          <div class="playCount">
    ...
    <el-tabs v-model="selectedTag" class="playlistContent" v-loading="false">
...
import { playlistDetailsApi, songDetailsApi, getPlayListDetail } from '@/api/playlist'
...
async function getPlaylistDetails() {
  ...
  const res: any = await getPlayListDetail(id.value)
  playlistDetails.value = res.details
